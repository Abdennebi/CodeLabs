...
public class GaeAuthenticationFilter extends GenericFilterBean {
    ...
    private final AuthenticationDetailsSource<HttpServletRequest, WebAuthenticationDetails> detailsSource = new WebAuthenticationDetailsSource();
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if (authentication == null) {
            if (googleUser != null) {
                ...
                token.setDetails(detailsSource.buildDetails((HttpServletRequest) request));
